...
#Path to input files
tree.file <-"Cytb_06-18-2025.treefile"
Metadata.file <- "D:/HDD drive/My_Drive/University of Illinois Urbana-Champaign/THESIS PROJECT/PROPOSALS/My_Dissertation/MasterSheet/MasterSheet_SH_v9.xlsx"

#Read in data
tree <- read.tree(tree.file)
MasterSheet <- read_excel(Metadata.file,na = "NA",trim_ws = T )

#show columns available in the metadata file
colnames(MasterSheet)

# Specify which columns to keep from the metadata file
Keep.columns <- c("Seq.ID","Latitude","Longitude","Site","HUC2Name",
